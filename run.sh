...
do
    ...
    do
        ...
        do
            ...
            python ./show_tables.py -dataset $dataset -output ../metrics/${model_name}_${mr}_${sample_size}_${sample_id}_${dlr_list[$lr_i]}_${glr_list[$lr_i]}_${d_step[$ds_i]}_${g_step[$gs_i]}
        done 
    done
done
echo 'finish'

...
sample_size=5000
sample_id=$1
dlr_list=(0.0005 0.001 0.005)
glr_list=(0.0025 0.0005 0.002)
d_step=(1 3 5)
g_step=(1 2)
...
do
    ...
    do
        ...
        do
            ...
            python ./show_tables.py -dataset $dataset -output ../metrics/$dataset/${model_name}_${mr}_${sample_size}_${sample_id}_${dlr_list[$bs_i]}_${glr_list[$bs_i]}_${d_step[$ds_i]}_${g_step[$gs_i]}
        done 
    done
done
echo 'finish'

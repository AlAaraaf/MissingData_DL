...
def gain_qrg (data_x, data_m, cat_index, num_index, all_levels, gain_parameters, num_imputations=10):
    # System parameters
    ...
    def gain_Gloss(sample, G_sample, D_prob, mask, n_classes):
        ...
        if num_index:
            ...
            reconstruct_loss += tf.reduce_mean(tf.math.abs(M_current * X_temp - M_current * G_sample_temp)) / tf.reduce_mean(M_current)
